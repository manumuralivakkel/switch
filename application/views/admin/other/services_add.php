...
<h2 style="margin-top:0; color:#7da546;">Add Service</h2>
...
<table class="add" style="margin-bottom:15px; border: 1px solid #d0cfcf;" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr><td>&nbsp;</td></tr>
          ...
          <tr>
        <td align="right" width="33%">Service</td>
        <td width="1%" style="padding:5px;">:</td>
        <td width="66%"><input name="text" type="text" class="inpuu"></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
         ...
         <tr>
	  	...
	  	<td width="1%" style="padding:5px;">:</td>
	    <td width="66%"><input class="inpuu" type="text"></td>
		</tr>
        
          
         <tr><td>&nbsp;</td></tr>
         <tr>
	  	<td align="right">Image[.jpg , .gif]</td>
	  	<td width="1%" style="padding:5px;">:</td>
		<td align="left">
